...
export default function ConnectWalletButton() {
  ...
  if (!appKitModal) {
     return (
      <Button variant="outline" disabled className="flex items-center space-x-2 border-destructive text-destructive h-12 text-base rounded-xl">
    ...
    return (
      <DropdownMenu>
        <DropdownMenuTrigger asChild>
          <Button variant="outline" size="lg" className="flex items-center space-x-2 text-base rounded-xl h-12">
  ...
  return (
    <div className="flex flex-col items-center w-full">
      <Button
        ...
        size="lg" // Use Shadcn large size
        className="bg-primary hover:bg-primary/90 w-full text-base rounded-xl h-12 shadow-md hover:shadow-lg transition-shadow"
      >
